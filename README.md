...
<h2>Пример POST запроса по /api/pereval/SubmitData/:</h2>
...
<h2>Ошибки и ответы API, которые могут возникнуть при работе с API:</h2>
...
<h2>Пример GET запроса по /api/pereval/SubmitData/filter/?user__email=<qwertyrrr@mail.ru></h2>
